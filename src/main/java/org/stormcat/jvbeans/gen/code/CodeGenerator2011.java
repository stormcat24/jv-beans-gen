...
import org.stormcat.jvbeans.gen.code.xls.Code2011;
 ...
 *
 */
public class CodeGenerator2011 extends CodeGenerator<Code2011> {
     ...
     */
    @Override
    protected List<Code2011> getCodeList() {
        CodeSheet sheet = JvBeansGenUtil.getSheet(CodeSheet.class);
        
        List<Code2011> codeList = new ArrayList<Code2011>();
        for (Code2011 code : sheet.getRow2011Items()) {
    ...
    protected String getJavadoc() {
        return "<b>2011.天候コード</b> のEnumによる表現です。";
    }
    ...
    protected String getTemplate() {
        return "src/main/resources/org/stormcat/jvbeans/gen/code/2011.vm";
    }
