...
public class JvResolverGenerator extends BaseGenerator {
    ...
    public JvResolverGenerator(String packageName, ItemType itemType, List<List<DataTypeRow>> lists) {
        super(packageName);
    ...
    private String createDataSpecName(String dataType) {
        StringBuilder sb = new StringBuilder("org.stormcat.jvbeans.jvlink.definitions.dataspec._");
